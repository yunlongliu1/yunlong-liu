...
| Ecommerce / D2C (C-end): Shopping feeds, Merchant Center, PMax for retail, ROAS bidding, high-AOV purchases | [google-ecommerce-playbook.md](references/google-ecommerce-playbook.md) | Feed quality, ecommerce build order, Standard Shopping vs PMax, ROAS ladder, considered-purchase adaptations, remarketing, promotions, MER |
