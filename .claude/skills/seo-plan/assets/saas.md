...
- Add FAQ content for common comparison questions (FAQPage rich results retired May 2026; keep markup only when it accurately represents visible FAQ content)
